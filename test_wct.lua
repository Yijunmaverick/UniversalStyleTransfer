...
function feature_swap_whiten(cF, sF)
   ...
   -- content feature whitening
    ...
    local c_u, c_e, c_v = torch.svd(contentCov, 'A')  
    ...
    local s_u, s_e, s_v = torch.svd(styleCov, 'A')
    ...
    local whiten_contentFeature = c_v[{{},{1,k_c}}]*torch.diag(c_d)*(c_v[{{},{1,k_c}}]:t())*contentFeature1
    ...
    local targetFeature = s_v[{{},{1,k_s}}]*(torch.diag(s_d1))*(s_v[{{},{1,k_s}}]:t())*swap_latent1
...
function feature_wct(cF, sF)
   ...
   -- content feature whitening
    ...
    local targetFeature = s_v[{{},{1,k_s}}]*(torch.diag(s_d1))*(s_v[{{},{1,k_s}}]:t())*whiten_contentFeature
