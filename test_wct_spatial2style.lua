...
cmd:option('-style', 'input/style/023.jpg,input/style/018.jpg','two style images, separate by comma')
cmd:option('-mask', 'input/mask/random_mask.jpg', 'A binary mask to apply spatial control')
